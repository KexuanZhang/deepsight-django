...
QuestionToQuery_docstring = """You want to answer the question using Google search, focusing on finding data, figures, or quantifiable information for the major company in the given context related to the topic. What do you type in the search box?
...
QueryRewrite_docstring = """Given a list of queries, rewrite them to improve hybrid (vector-similarity + BM25) RAG retrieval while ensuring that every detected entity (such as companies, key executives, financial instruments, products, or divisions) can also be searched directly.
