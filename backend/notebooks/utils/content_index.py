...
class ContentIndexingService:
    ...
    def index_content(
        ...
        try:
            ...
            self.log_operation(
                "index_content",
                f"file_id={file_id}, stage={processing_stage}, keywords={len(keywords)}",
            )
    ...
    async def search_content(
        ...
        try:
            ...
            self.log_operation(
                "search_content", f"query='{query}', results={len(results)}"
            )
            return results
        ...
        try:
            ...
            for file_id, index_data in self.search_index.items():
                ...
                if partial_lower in content_lower:
                    ...
                    words = re.findall(
                        r"\b" + re.escape(partial_lower) + r"\w*", content_lower
                    )
            ...
            self.log_operation(
                "get_suggestions",
                f"query='{partial_query}', suggestions={len(suggestion_list)}",
            )
    ...
    async def get_index_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            total_content_length = sum(
                data["content_length"] for data in self.search_index.values()
            )
    ...
    def _calculate_relevance_score(
        self, query_terms: List[str], index_data: Dict[str, Any]
    ) -> float:
    ...
    def _extract_snippet(
        self, query: str, content: str, snippet_length: int = 200
    ) -> str:
    ...
    def _load_search_index(self):
        ...
        try:
            ...
            if index_file.exists():
                ...
                self.log_operation(
                    "load_index", f"loaded {len(self.search_index)} files"
                )
        except Exception as e:
