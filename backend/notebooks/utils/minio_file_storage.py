...
Replaces the local filesystem-based FileStorageService with MinIO object storage.
"""
...
class MinIOFileStorageService:
    ...
    def __init__(self):
        self.service_name = "minio_file_storage"
        self.logger = logging.getLogger(f"{__name__}.minio_file_storage")
...
minio_file_storage_service = MinIOFileStorageService()