    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('processing_status', models.CharField(choices=[('processing', 'Processing'), ('in_progress', 'In Progress'), ('done', 'Done'), ('failed', 'Failed')], db_index=True, default='processing', help_text='Processing status of this knowledge base item', max_length=20)),
                ...
                ('file_metadata', models.JSONField(default=dict, help_text='File metadata stored in database')),
            ],
            options={
