...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='knowledgebaseimage',
            constraint=models.CheckConstraint(condition=~models.Q(('minio_object_key', '')), name='image_object_key_not_empty'),
        ),
        migrations.AddIndex(
            model_name='notebook',
        ...
        migrations.AddIndex(
            model_name='knowledgebaseitem',
            index=models.Index(fields=['notebook', 'processing_status'], name='notebooks_k_noteboo_2ba409_idx'),
        ),
        migrations.AddIndex(
            model_name='knowledgebaseitem',
        ...
        migrations.AddConstraint(
            model_name='knowledgebaseitem',
            constraint=models.CheckConstraint(condition=~models.Q(('title', '')), name='knowledge_item_title_not_empty'),
        ),
        migrations.AddIndex(
            model_name='batchjob',
        ...
        migrations.AddConstraint(
            model_name='notebookchatmessage',
            constraint=models.CheckConstraint(condition=~models.Q(('message', '')), name='chat_message_not_empty'),
        ),
    ]
