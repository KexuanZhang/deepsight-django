    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('include_image', models.BooleanField(default=False, help_text='Whether to include figure data (images) during report generation')),
                ...
                ('result_metadata', models.JSONField(blank=True, default=dict, help_text='Additional result metadata')),
                ...
                ('figure_data_object_key', models.CharField(blank=True, help_text='MinIO object key for combined figure_data.json file', max_length=255, null=True)),
