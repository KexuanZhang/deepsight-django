    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "article_title",
                    models.CharField(default="Research Report", max_length=255),
                ),
                (
                    "model_provider",
                    models.CharField(
                        choices=[("openai", "OpenAI")], default="openai", max_length=50
                    ),
                ),
                (
                    "retriever",
                    models.CharField(
                        choices=[("tavily", "Tavily")], default="tavily", max_length=50
                    ),
                ),
