...
class ReportViewSet(viewsets.ModelViewSet):
        ...
        try:
            ...
            if instance.main_report_file:
                try:
                    ...
                    logger.warning(f"Could not delete report files for {instance.id}: {e}")
    ...
    def generate(self, request):
        ...
        try:
            ...
            logger.info(f"Report generation job {job_id} queued successfully for report {report.id}")
            ...
            for report in reports:
                if report.status == Report.STATUS_COMPLETED:
                    ...
                    if report.main_report_file or report.result_content:
                        ...
                        logger.warning(f"Skipping phantom job {report.job_id} - no files found")
                else:
        ...
        try:
            ...
            if report.result_content:
                return Response({
                    ...
                    "article_title": report.result_metadata.get("article_title", report.article_title),
    ...
    def available_models(self, request):
        ...
        try:
            return Response({
                ...
                "prompt_types": [choice[0] for choice in Report.PROMPT_TYPE_CHOICES],
                "search_depths": [choice[0] for choice in Report.SEARCH_DEPTH_CHOICES],
            })
        except Exception as e:
