...
class PodcastJobSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PodcastJob
        fields = [
            'job_id', 'title', 'description', 'status', 'progress',
            'created_at', 'updated_at', 'audio_url', 'conversation_text',
            'error_message', 'source_file_ids', 'source_metadata',
            'duration_seconds'
        ]
        read_only_fields = [
            'job_id', 'status', 'progress', 'created_at', 'updated_at',
            'audio_url', 'conversation_text', 'error_message', 'duration_seconds'
        ]
...
class PodcastJobListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'job_id', 'title', 'description', 'status', 'progress',
            'created_at', 'updated_at', 'audio_url', 'error_message',
            'duration_seconds'
        ]
