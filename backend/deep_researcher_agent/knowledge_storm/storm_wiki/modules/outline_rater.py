    ...
    def rate_and_reassemble_outline(
        ...
        try:
            ...
            l1_ratings = rate_outline(
                self.client, outline, conv_history, transcript, paper_content
            )
...
def main():
    ...
    parser.add_argument(
        "--transcript", help="Path to file containing transcript (optional)"
    )
    parser.add_argument(
        "--paper", help="Path to file containing paper content (optional)"
    )
    ...
    if args.stage == "A":
        ...
        rating_result = rate_outline(
            rater.client, outline_content, conv_history, transcript, paper_content
        )
