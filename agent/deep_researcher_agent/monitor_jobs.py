                ...
                if response.status_code == 200:
                    ...
                    if active_jobs:
                        ...
                        for job in active_jobs:
                            ...
                            print(f"  {status_emoji} {job['job_id'][:8]}... | {job['status'].upper()} | {job['article_title']}")
                            print(f"     Model: {job['model_provider']} | Retriever: {job['retriever']}")
                        print()
                    ...
                    if completed_jobs:
                        ...
                        for job in completed_jobs:
                            print(f"  ✅ {job['job_id'][:8]}... | {job['article_title']}")
                        print()
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    print(f"\r{datetime.now().strftime('%H:%M:%S')} | "
                          ...
                          f"Progress: {status['progress']}", end="", flush=True)
